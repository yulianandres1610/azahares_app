...
const STR: { en: Dict; es: Dict } = {
  en: {
    ...
    bioNeedLoginFirst: 'Sign in with your email once to enable biometric login.',
    phoneInvalid: 'The phone number must have 10 digits.',
    ...
    errorNotFound: 'Not found — it may have been deleted.',
    ...
    gatewayReqHint: 'Required · printed on the device (e.g. G4NS-5RG-FDB)',
    ...
    // detail tabs + container info
    tabInspection: 'Inspection',
    tabContainer: 'Container',
    yard: 'Yard',
    currentState: 'Current state',
    lastUpdate: 'Last update',
    creationPhotos: 'Creation photos',
    creationPhotosSub: 'Taken when the container was registered',
    noPhotos: 'No photos at creation',
  ...
  es: {
    ...
    bioNeedLoginFirst: 'Inicia sesión con tu correo una vez para habilitar el acceso biométrico.',
    ...
    errorNoPermission: 'No tenés permiso para realizar esta acción',
    errorNetwork: 'Sin conexión. Revisá tu internet.',
    errorNotFound: 'No se encontró — puede que haya sido eliminado.',
    errorSession: 'Tu sesión expiró. Iniciá sesión de nuevo.',
    errorServer: 'Error del servidor. Intentá de nuevo en un momento.',
    errorTooLarge: 'El archivo es demasiado grande.',
    ...
    gatewayReqHint: 'Obligatorio · impreso en el dispositivo (ej. G4NS-5RG-FDB)',
    ...
    tabContainer: 'Contenedor',
    yard: 'Yarda',
    currentState: 'Estado actual',
    lastUpdate: 'Última actualización',
    creationPhotos: 'Fotos de creación',
    creationPhotosSub: 'Tomadas al registrar el contenedor',
    noPhotos: 'Sin fotos al crear',
